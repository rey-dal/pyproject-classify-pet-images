...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # Labels Match - / Step A: Number of Correct Matches
        ...
        #           
        # Pet Image Label is a Dog AND Labels match-> this counts the Correct Breed  /# Step E: Number of Correct Breed Matches

        if results_dic[key][3] == 1 and results_dic[key][2] == 1:
            results_stats_dic['n_correct_breed'] += 1
        
        # Pet Image Label is a Dog -> this counts the number of dog images /  # Step B: Number of Dog Images
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img'] += 1
            
            # Classifier classifies image as Dog (& pet image is a dog)

            # counts number of correct dog classifications / # Step C: Number of Correct Dog Classifications
        ...
        #           
        # Pet Image Label is NOT a Dog / # Step D: Number of Correct NOT Dog Classifications
    ...
    # calculates number of total images / # Step F: Calculate Statistics based on counters above
