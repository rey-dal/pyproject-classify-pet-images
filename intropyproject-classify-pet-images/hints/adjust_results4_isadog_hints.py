    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            if line not in dognames_dic:
                dognames_dic[line] = 1 #add dogname to dognames_dic if it doesn't exist
    ...
    for value in results_dic.values():
        ...
        if value[0] in dognames_dic:
            ...
            # appends (1,0) because only pet label is a dog
                ...
                value.extend((1, 0)) #Pet label is dog, classifier is not
        ...
        # Pet Image Label IS NOT a Dog image (e.g. NOT found in dognames_dic)
            ...
            if value[1] in dognames_dic:
                value.extend((0, 1)) #Pet label is not dog, classifier is dog
            ...
            # appends (0, 0) because both labels aren't dogs
                ...
                value.extend((0, 0)) #Pet label is not dog, classifier is not dog
